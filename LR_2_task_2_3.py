...
print("--- Сигмоїдальне ядро (sigmoid) ---")
print(f"Accuracy: {round(100 * accuracy_score(y_test, y_test_pred), 2)}%")
print(f"Precision: {round(100 * precision_score(y_test, y_test_pred, average='weighted', zero_division=0), 2)}%")
print(f"Recall: {round(100 * recall_score(y_test, y_test_pred, average='weighted', zero_division=0), 2)}%")
